export default class TreeNode<T> {
     ...
     * @param elements TreeNode의 chilrdren(서브트리)
    ...
    /**
     * 삭제하고자하는 Tree의 부모를 찾고, 해당 부모의 자식요소 중 삭제하고자 하는 Tree를 제거
